CREATE TEMP TABLE character_role_runtime_migration_guard (
    value INTEGER CONSTRAINT character_role_runtime_midstate_data_present CHECK (value = 0)
);

INSERT INTO character_role_runtime_migration_guard
...
UNION ALL
SELECT 1 WHERE EXISTS (SELECT 1 FROM story_segments);

ALTER TABLE stories RENAME COLUMN player_character_id TO player_role_id;
...
DROP TABLE character_role_runtime_migration_guard;
