...
impl AssetValidationCode {
    pub fn as_str(&self) -> &'static str {
        match self {
            ...
            AssetValidationCode::MissingDefaultCast => "missing_default_cast",
            AssetValidationCode::MissingPlayableOpening => "missing_playable_opening",
            AssetValidationCode::CharacterIdentityFieldInRole => "character_identity_field_in_role",
